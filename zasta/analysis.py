...
from zasta.language import LanguageModel, new_sentences, MarkovProfiler
import pandas as pd
...
if __name__ == "__main__":
    ...
    generators = [
        LanguageModel(order=4, temperature=1),
        LanguageModel(order=2, temperature=3),
        LanguageModel(order=1, temperature=4),
    ]
